...
#
"""
Access Humanality artwork.
Based directly on Bioicons script by Simon Deurr.
...
class Humanality(RemoteSource):
    name = "Humanality Project"
    icon = "sources/humanality.svg"
    db_url = "https://rolandixor.pro/assets/humanality.json"
    icon_url = "https://rolandixor.pro/assets/humanality"
    ...
    def __init__(self, cache_dir):
        ...
        self._json = os.path.join(self.cache_dir, "humanality.json")
    ...
    def search(self, query):
        ...
        for item in results:
            yield {
                ...
                "popularity": 0,
                "author": item["author"],
                "thumbnail": f"{self.icon_url}/{item['name']}.svg",
                "file": f"{self.icon_url}/{item['name']}.svg",
